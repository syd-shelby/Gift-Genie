...
class SignInModule extends StatefulWidget {
  @override
  _SignInModuleState createState() => new _SignInModuleState();
}
                ...
                children: <Widget>[
                  new Container(
                    ...
                    child: new IconButton(icon: Icon(
                      FontAwesomeIcons.twitter, color: Color(0xFF0084ff),),
                        onPressed: () async {
                          ...
                          if (StateWidget
                            ...
                            Scaffold.of(context).showSnackBar(new SnackBar(
                              content: new Text("Twitter Login Failed..."),
                            ));
                            //}
                          }
                        }),
                      ...
                      FontAwesomeIcons.google, color: Color(0xFF0084ff),),
                        onPressed: () async {
                          ...
                          if (StateWidget
                            ...
                            Scaffold.of(context).showSnackBar(new SnackBar(
                              content: new Text("Google Login Failed..."),
                            ));
                            //}
                          }
                        }),
        ...
        onTap: () async {
          ...
          if (_SignInFormKey.currentState.validate()) {
            Scaffold.of(context).showSnackBar(
                new SnackBar(content: new Text("Loging in")));
